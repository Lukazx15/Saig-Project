...
export const en: Messages = {
  ...
  registerSsoBanner: 'KMITL SSO verified — student ID, email, and faculty are locked to your account.',
  ...
  registerFacultyFromId: 'Derived from your student ID — cannot be changed.',
  registerYear: 'Year',
  registerMajor: 'Major',
  ...
  boardTitle: "What your mood today?",
