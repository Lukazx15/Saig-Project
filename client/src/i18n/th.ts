...
export const th: Messages = {
  ...
  loginKmitl: 'เข้าสู่ระบบด้วย KMITL',
  ...
  registerSubtitle: 'ยืนยันตัวตนด้วยบัญชี KMITL ก่อน แล้วค่อยเติมโปรไฟล์ให้ครบ',
  registerSubtitleSso: 'ยืนยันตัวตนกับ KMITL แล้ว เหลือแค่เติมโปรไฟล์ให้ครบ',
  registerSsoBanner: 'ผ่าน KMITL SSO แล้ว รหัสนักศึกษา อีเมล และคณะจะผูกกับบัญชีนี้',
  registerContinueKmitl: 'ดำเนินการต่อด้วย KMITL',
  registerLoading: 'กำลังตรวจสอบเซสชัน KMITL…',
  registerEmail: 'อีเมล KMITL',
  registerFaculty: 'คณะ',
  registerFacultyFromId: 'ดึงจากรหัสนักศึกษา — แก้ไม่ได้',
  registerYear: 'ชั้นปี',
  registerMajor: 'สาขา',
